"""
Django settings for twitter-djavue project.
...
ROOT_URLCONF = 'twitter-djavue.urls'
...
WSGI_APPLICATION = 'twitter-djavue.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './twitter-djavue.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
